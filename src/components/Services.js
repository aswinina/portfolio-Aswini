            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-3 col-sm-6">
                        <div className="box">
                            <div className="cricle"><FontAwesomeIcon className="icon" icon={faDesktop} size="2x" /></div>
                            <h3>Web Design</h3>
                    ...
                    <div className="col-md-3 col-sm-6">
                        <div className="box">
                        <div className="cricle"><FontAwesomeIcon className="icon" icon={faFileCode} size="2x" /></div>
                    ...
                    <div className="col-md-3 col-sm-6">
                        <div className="box">
                        <div className="cricle"><FontAwesomeIcon className="icon" icon={faFacebookF} size="2x" /></div>
                    ...
                    <div className="col-md-3 col-sm-6">
                        <div className="box">
                        <div className="cricle"><FontAwesomeIcon className="icon" icon={faGoogle} size="2x" /></div>
                            <h3>Google Ads</h3>
